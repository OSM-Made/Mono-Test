...
void UI::Custom_Content::StartDebugSettings_Hook(MonoObject* Instance)
{
	...
	Mono::Invoke<void>(Mono::App_exe, UIManager, Mono::Get_Field<MonoObject*>(UIManager, Instance, "uiManager"), "PushWizard", Mono::New_String("orbis_toolbox.xml"), Mono::New_String("id_orbis_toolbox"), 3);
}
