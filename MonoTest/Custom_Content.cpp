...
MonoObject* UI::Custom_Content::ExecuteSelectQuery_Hook(MonoObject* Instance, int offset, int limit)
{
	...
	MonoClass* AppBrowseItemAccessor = Mono::Get_Class(Mono::Accessor_Db, "Sce.Vsh.Accessor.Db", "AppBrowseItemAccessor");
...
MonoString* UI::Custom_Content::GetIconPath_Hook(MonoObject* item, bool withTheme)
{
	...
	char* TitleId = mono_string_to_utf8(Mono::Get_Property<MonoString*>(AppBrowseItemLite, "TitleId", item));
